  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section ref={heroRef} id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden" onMouseMove={handleHeroMouseMove}>
        ...
        {/* Top-left: CTR card */}
        <motion.div
          className="absolute top-28 left-[8%] md:left-[12%] z-[2] hidden md:block"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 1.4 }}
        >
          <motion.div
            className="bg-card/60 backdrop-blur-xl border border-primary/20 rounded-xl px-4 py-3 min-w-[140px]"
            animate={{ y: [0, -8, 0] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          >
            ...
            <div className="flex items-end gap-[2px] mt-2 h-4">
              {[40, 65, 45, 80, 60, 90, 75].map((h, i) => (
                <motion.div
                  key={i}
                  className="w-[4px] bg-primary/60 rounded-full"
                  initial={{ height: 0 }}
                  animate={{ height: `${h}%` }}
        ...
        {/* Top-right: Conversions card */}
        <motion.div
          className="absolute top-32 right-[8%] md:right-[12%] z-[2] hidden md:block"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            ...
            <div className="flex items-end gap-2 mt-1">
              <span className="text-xl font-bold text-foreground">2,847</span>
              <span className="text-[10px] text-green-400 font-medium flex items-center">
            ...
            <div className="mt-2 flex items-center gap-2">
              <svg width="20" height="20" viewBox="0 0 20 20">
                <circle cx="10" cy="10" r="8" fill="none" stroke="hsl(24 100% 50% / 0.15)" strokeWidth="2" />
                <motion.circle
                  cx="10" cy="10" r="8" fill="none" stroke="hsl(24 100% 50%)" strokeWidth="2"
                  strokeDasharray="50.26" strokeLinecap="round"
              ...
              <span className="text-[10px] text-muted-foreground">76% of goal</span>
            </div>
          </motion.div>
        </motion.div>
        ...
        {/* Mid-left: ROAS badge */}
        <motion.div
          className="absolute top-[45%] left-[3%] md:left-[6%] z-[2] hidden lg:block"
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 1.8 }}
        >
          <motion.div
            className="bg-card/50 backdrop-blur-xl border border-primary/15 rounded-lg px-3 py-2"
            animate={{ y: [0, -6, 0] }}
            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          >
            <p className="text-[9px] text-muted-foreground uppercase tracking-wider">ROAS</p>
            <span className="text-lg font-bold text-primary">5.2x</span>
          </motion.div>
        </motion.div>

        {/* Mid-right: CPA badge */}
        <motion.div
          className="absolute top-[40%] right-[3%] md:right-[6%] z-[2] hidden lg:block"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          >
            <p className="text-[9px] text-muted-foreground uppercase tracking-wider">Avg. CPA</p>
            <span className="text-lg font-bold text-foreground">$1.24</span>
          </motion.div>
        </motion.div>

        {/* Bottom-left area: Live data line */}
        <motion.div
          className="absolute bottom-32 left-[15%] z-[2] hidden md:block"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.5 }}
        ...
        >
          <svg width="120" height="40" viewBox="0 0 120 40" className="overflow-visible">
            <motion.path
              ...
              fill="none" stroke="hsl(24 100% 50%)" strokeWidth="1.5" strokeLinecap="round"
              initial={{ pathLength: 0 }}
              animate={{ pathLength: 1 }}
              transition={{ duration: 2, delay: 2.5, ease: "easeOut" }}
            />
            <motion.circle
              cx="120" cy="8" r="3" fill="hsl(24 100% 50%)"
              initial={{ opacity: 0 }}
        ...
        {/* Bottom-right area: Impressions ticker */}
        <motion.div
          className="absolute bottom-36 right-[15%] z-[2] hidden md:block"
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.4 }}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-muted-foreground font-mono">12.4M impressions today</span>
          </div>
        </motion.div>

        {/* Floating connection lines */}
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-[1] hidden lg:block" style={{ opacity: 0.08 }}>
          <motion.line x1="12%" y1="30%" x2="35%" y2="45%" stroke="hsl(24 100% 50%)" strokeWidth="1" strokeDasharray="4 4"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, delay: 3 }} />
          <motion.line x1="88%" y1="35%" x2="65%" y2="48%" stroke="hsl(24 100% 50%)" strokeWidth="1" strokeDasharray="4 4"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, delay: 3.2 }} />
          <motion.line x1="15%" y1="70%" x2="40%" y2="55%" stroke="hsl(24 100% 50%)" strokeWidth="1" strokeDasharray="4 4"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, delay: 3.4 }} />
          <motion.line x1="85%" y1="65%" x2="60%" y2="52%" stroke="hsl(24 100% 50%)" strokeWidth="1" strokeDasharray="4 4"
            initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 2, delay: 3.6 }} />
        </svg>
        <motion.div
